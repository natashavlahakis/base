    ...
    <div class="row">
      ...
      <div class="col-5 px-0">
        <form class="form-inline">
          <label class="mr-sm-2" for="inlineFormCustomSelect">Games</label>
    ...
    <div class="col-8 mt-3 mb-5">
      ...
      <div class="row">
        ...
        <div class="col-6">
          ...
          <p><?php echo get_post_meta($post->ID, 'host-nation', true); ?></p>
      ...
      <div class="row">
        ...
        <div class="col-6">
          ...
          <p><?php echo get_post_meta($post->ID, 'events', true); ?></p>
      ...
      <div class="row">
        ...
        <div class="col-6">
          ...
          <p><?php echo get_post_meta($post->ID, 'athletes', true); ?></p>
      ...
      <div class="row px-3">
        ...
        <h1 class="text-uppercase mt-4 mb-3">Game Summary</h1>
      ...
      <h1 class="text-uppercase mt-4 mb-3">More Games</h1>
      ...
      <div class="row">
        ...
        $args = array( 'post_type' => 'games', 'posts_per_page' => 3, 'post__not_in'=> array($postid) );
